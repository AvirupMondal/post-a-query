...
//     $subject=get_safe_data($con,$_POST['subject']);
//     $question_sqli="Select queries.*, users.* from queries, users where queries.Student_Id=users.id and queries.year='$year' and queries.stream='$stream'";
//     echo $question_sqli;
...
// else{
    ...
    $stream= $_SESSION['Stream'];
    $semester= $_SESSION['Semester'];
    $question_sqli="Select queries.*, users.* from queries, users where queries.Student_Id=users.id and queries.year='$year' and queries.semester='$semester' and queries.stream='$stream' order by Query_Id desc";
    //  echo $question_sqli;
    //  die();
          ...
          <div class="row">
            <!-- <div class="col-lg-2 sidebar">
                ...
                <button style="margin-top:1rem" type="button" class="btn btn-outline-primary" onclick="search()"  name="filter_submit">Search</button>
                      <button type="submit" class="btn btn-outline-primary" name="filter_submit" style="margin-top:1rem">Post</button>
                      <div ><p id="field_error"></p></div>
                </form>
            </div> -->
            <div class=" col-lg-6 offset-3" id="getting_queries">
                 <?php 
          ...
          <div class="middle" >
              ...
              <div class="info">
                <em class="fas fa-user-circle"></em>
                  <h5 style="color:blue"><?php echo $post_name;?></h5>
                  <p style="color:red"><?php echo $post_stream .','.' '.$post_year.'th Year,'.' '.$post_sem.'th Sem,';?></p>
              </div>
                <div class="question">
                    <h6 >Question</h6>
                ...
                <div class="answer">
                    ...
                    <div class="answerdisplay">
                        ...
                        <div class="answers">
                            <h6 style="color:red"><?php echo $answer_name;?></h6>
                           
                            <h6 style="color:blue"><?php echo $answer_stream .','.' '.$answer_year.'th Year,'.' '.$answer_sem.'th Sem,';?></h6>
                            <p><?php echo $answer;?></p>
                        </div>
                    </div><?php } ?>
                </div>
